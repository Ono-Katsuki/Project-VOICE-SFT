...
BUCKET_NAME = os.environ.get("BUCKET_NAME", "your-gcs-bucket")
GCS_PREFIX = os.environ.get("GCS_PREFIX", "gemini25_sft/auxiliary_synthesis")

# Point LOCAL_TRAIN_FILE at your own JSONL. The original filename is
# preserved below as documentation of the canonical dataset name.
LOCAL_TRAIN_FILE = os.environ.get(
    "LOCAL_TRAIN_FILE",
    "text2seg_surface_yomi_arraystr_with_prompt.jsonl",
)
LOCAL_VALID_FILE = os.environ.get("LOCAL_VALID_FILE", "")

SOURCE_MODEL = "gemini-2.5-flash"
TUNED_MODEL_DISPLAY_NAME = os.environ.get(
    "TUNED_MODEL_DISPLAY_NAME",
    "voice-auxiliary-synthesis",
)
