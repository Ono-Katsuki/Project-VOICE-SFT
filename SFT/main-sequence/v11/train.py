...
GCS_PREFIX = os.environ.get("GCS_PREFIX", "gemini25_sft/run11")

# Point LOCAL_TRAIN_FILE at your own JSONL. The original training file is
# personal data and is not published; the filename below documents the
# canonical v11 dataset name.
